const projects = [
    ...
    },
    {
      ...
      description: "Developed a lightweight character-level Transformer model from scratch in PyTorch to generate Shakespearean-style text. Trained on a custom dataset, with evaluations on perplexity, accuracy, sentiment, and style reproduction. Focused on balancing performance and efficiency under limited resources.",
      link: "https://github.com/elc277/LLM"
    },
    {
      title: "Cooking Companion - Conversational Recipe Recommender",
      description: "Built a speech-based conversational agent that recommends recipes based on user preferences like ingredients, cooking time, and dietary constraints. Integrated a Prolog-based knowledge base with a custom NLU pipeline, voice recognition, and visual UI. Supported dynamic dialogue flow, intent/slot classification, and creative user interactions.",
      link: "https://github.com/VU-PCA-2025/agent-group-b1-1"
    },
    {
      title: "Personal Website - Portfolio & Resume Platform",
      description: "Designed and developed a fully responsive personal website using React for the frontend and Flask for the backend. It features a portfolio section, skills overview, project gallery with API integration, and contact options. Includes animations, a dark-themed UI, and is deployed using Render and Netlify.",
